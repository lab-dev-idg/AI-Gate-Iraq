...
const weaknessItems: Array<{ title: LocalText; impact: LocalText; benchmark: LocalText; fix: LocalText; severity: 'high' | 'medium' | 'low' }> = [
  ...
  },
  {
    ...
    fix: { ku: 'کارتێکی “ئاستی متمانە” و بەرواری نوێکردنەوە زیاد بکە بۆ هەر وەڵام و هەر بەش.', ar: 'إضافة بطاقة “مستوى الثقة” وتاريخ آخر تحديث لكل إجابة ووحدة.' },
    severity: 'high',
  },
  {
  ...
  },
  {
    ...
    impact: { ku: 'بازرگان پێویستی بە بەراوردی نرخ، مەترسی، کات و بەڵگەنامە هەیە.', ar: 'التاجر يحتاج مقارنة واضحة للسعر والمخاطر والوقت والمستندات.' },
  ...
  },
  {
    ...
    impact: { ku: 'ناتوانرێت بزانرێت کام بەش نرخ، lead و retention زیاد دەکات.', ar: 'لا يمكن معرفة أي وحدة ترفع التحويل والاحتفاظ والعملاء المحتملين.' },
...
const roadmap: Array<{ phase: LocalText; items: LocalText[] }> = [
  {
    ...
    items: [
      { ku: 'Header ـی هەر بەش بکە بە کورتەی سوود، کاتی پێویست و دەرئەنجام.', ar: 'تحويل رأس كل وحدة إلى ملخص للفائدة والوقت والنتيجة.' },
