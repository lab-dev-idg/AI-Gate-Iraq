...
const DEFAULT_CONFIG: ReadinessConfig = {
  ...
  steps: [
    ...
    { ku: 'دەرئەنجامەکە بە دۆکیومێنتەکان بەراورد بکە.', ar: 'قارن النتيجة مع المستندات.' },
    { ku: 'ئەنجامەکە چاپ یان دابەزێنە و لەگەڵ تیمەکەت هاوبەشی بکە.', ar: 'اطبع أو نزّل النتيجة وشاركها مع فريقك.' },
  ],
  prompt: {
...
const READINESS_CONFIG: Partial<Record<ServiceKey, ReadinessConfig>> = {
  ...
  cost: {
    ...
    updated: { ku: 'نوێکردنەوە: کاتی حیسابکردن', ar: 'التحديث: وقت الحساب' },
    ...
    steps: [
      ...
      { ku: 'PDF/print وەک پێشنیازی ناوخۆی تیم بەکاربهێنە.', ar: 'استخدم الطباعة كعرض داخلي للفريق.' },
    ],
  ...
  kyc: {
    outcome: { ku: 'فایلێکی KYC ـی ڕێکخراو بە دۆکیومێنت، کەموکوڕی و هەنگاوی پەسەندکردن.', ar: 'ملف KYC منظم بالمستندات والنواقص وخطوة الاعتماد.' },
  ...
  audit: {
    outcome: { ku: 'خاڵە لاوازەکان، benchmark ـی جیهانی و backlog ـی جێبەجێکردن بۆ تیمی product.', ar: 'نقاط الضعف والمعيار العالمي و backlog تنفيذي لفريق المنتج.' },
