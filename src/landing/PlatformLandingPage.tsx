...
const content = {
  ku: {
    features: 'تواناکان', useCases: 'بەکارهێنان', security: 'پاراستن', open: 'کردنەوەی پلاتفۆرم',
    eyebrow: 'پلاتفۆرمی زیرەکی بازرگانی و گواستنەوە بۆ عێراق', titleA: 'بڕیارە بازرگانییەکانت', titleB: 'خێراتر و ڕوونتر بکە',
    lead: 'AI Gate Iraq ڕێنمایی، خەمڵاندنی تێچوو، دابینکردن، گومرگ و بەدواداچوونی بار لە یەک شوێنی کاری زیرەکدا کۆدەکاتەوە.',
    explore: 'بینینی تواناکان', trustA: 'دروستکراو بۆ بازاڕی عێراق', trustB: 'کوردی، عەرەبی، ئینگلیزی', trustC: 'Firebase + App Check',
    previewTitle: 'ڕاوێژکاری بازرگانی و گواستنەوە', question: 'چۆن تێچووی هاوردەکردنی بارێک بۆ هەولێر بخەمڵێنم؟',
    answer: 'جۆری کاڵا، کێش، قەبارە، شوێنی سەرچاوە و ڕێڕەوی گواستنەوە بنێرە تا خەمڵاندنێکی ڕێکخراو ئامادە بکەم.',
    core: 'خزمەتگوزاری سەرەکی', langs: 'زمانی بەردەست', workspace: 'شوێنی کاری یەکگرتوو',
    ...
    f1: 'ڕاوێژکاری زیرەک', f1d: 'وەڵامی ڕێکخراو بۆ پرسیارەکانی بازرگانی، گومرگ و گواستنەوە.',
    ...
    f4: 'بازاڕ و مەرزەکان', f4d: 'کورتەی بازاڕ، دۆخی مەرز و ڕێڕەوی گواستنەوە.',
    useEyebrow: 'بۆ کێ دروستکراوە؟', useTitle: 'بۆ گرووپەکانی هاوردە، بازرگانی و گواستنەوە',
    u1: 'کەمکردنەوەی کاتی گەڕان بەدوای زانیاری', u2: 'ڕێکخستنی بڕیار و بەڵگەنامەکان لە یەک شوێن', u3: 'خەمڵاندنی خێراتر پێش پەیوەندی بە دابینکەر', u4: 'پاراستنی مێژووی گفتوگۆ و کار',
    secEyebrow: 'متمانە و پاراستن', secTitle: 'دروستکراو بە بنەمای پاراستن و سادەیی', secText: 'Firebase Authentication، Firestore Rules و App Check بۆ کەمکردنەوەی داواکاری نادروست و پاراستنی دەستگەیشتن بەکاردهێنرێن.',
