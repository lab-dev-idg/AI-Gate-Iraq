  ...
  switch (service) {
    ...
    case 'cost':
      return [
        ...
        { label: lang === 'ar' ? 'البيانات المطلوبة للحساب' : 'زانیاری پێویست بۆ خەمڵاندن', prompt: lang === 'ar' ? 'ما هي البيانات بالتفصيل المطلوبة لحساب سعر الشحن والتعرفة الجمركية؟' : 'کام زانیاری بە وردی پێویستە بۆ حیسابکردنی نرخی گەیاندن و تاریفەی گومرگی؟' },
      ];
    case 'kyc':
      return [
        { label: lang === 'ar' ? 'مستندات تسجيل الشركة' : 'دۆکیومێنتی پێویست بۆ تۆمارکردن', prompt: lang === 'ar' ? 'ما هي المستندات والإجراءات القانونية المطلوبة لتسجيل شركة تجارية في العراق؟' : 'چ دۆکیومێنت و ڕێکارێکی یاسایی پێویستە بۆ تۆمارکردنی کۆمپانیایەکی بازرگانی لە عێراق؟' },
    ...
    default:
      return [
        ...
        { label: lang === 'ar' ? 'كيف أستورد بضائع من الخارج؟' : 'چۆن کاڵا لە دەرەوە بهێنم؟', prompt: lang === 'ar' ? 'ما هي الخطوات والخدمات اللوجستية المطلوبة لاستيراد حاويات من تركيا أو الصين؟' : 'هەنگاو و ڕێکارە لۆجیستییەکان چیین بۆ هێنانی کۆنتێنەر لە چین یان تورکیاوە؟' },
        { label: lang === 'ar' ? 'ما هي الوثائق المطلوبة؟' : 'چ دۆکیومێنتێک پێویستە؟', prompt: lang === 'ar' ? 'ما هي قائمة الأوراق والوثائق الرسمية للتخليص الجمركي في المعابر العراقية؟' : 'چ دۆکیومێنت و بەڵگەنامەیەکی فەرمی پێویستە بۆ تەرخیسکردنی گومرگی لە مەرزەکاندا؟' },
      ];
  }
};
