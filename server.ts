...
function getFallbackResponse(userMessage: string): string {
  ...
  if (isKurdish) {
    if (msg.includes("سڵاو") || msg.includes("باشی") || msg.includes("کێیت")) {
      return `ئاگاداری: وەڵامی ئێستا لە فۆڵباکی ناوخۆیی AI Gate Iraq ـە چونکە سنووری Gemini API تێپەڕاوە. ئەم وەڵامە سنووردارە و جێگرەوەی تەواوی AI نییە.
...
تۆ هەروەها دەتوانیت لە ڕێگەی دوگمەی "سەرنج و تێبینی" فیدباک بنێریت یان پەیوەندی بە کارمەندانی پشتگیریمان بکەیت.`;
    ...
    if (msg.includes("مرحبا") || msg.includes("اهلين") || msg.includes("هلا") || msg.includes("من انت")) {
      return `تنبيه: هذه إجابة احتياطية محلية من AI Gate Iraq لأن حصة Gemini API تم تجاوزها. هذه الإجابة محدودة وليست بديلاً كاملاً عن نموذج الذكاء الاصطناعي.
