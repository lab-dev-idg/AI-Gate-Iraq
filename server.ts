...
function getFallbackResponse(userMessage: string): string {
  ...
  if (isKurdish) {
    if (msg.includes("سڵاو") || msg.includes("باشی") || msg.includes("کێیت")) {
      return `⚠️ **(سیستەمی فریاگوزاری دەرەهێڵ - بەهۆی تەواوبوونی کووتای Gemini API)**

سڵاو! من یاریدەدەری زیرەکی **Lombenax AI**م. بەهۆی قەرەباڵغی زۆرەوە یاخود تەواوبوونی لیمیت، ئێستا لە ڕێگەی مۆدیلی لۆکاڵی فریاگوزارییەوە وەڵامت دەدەمەوە.
...
ئایا دەتەوێت نرخی بەهای لۆجیستیکی وردت بۆ حیساب بکەین؟ داوای Quote بکە!`;
    }
...
<div class="quote-report font-semibold p-4 rounded-xl border border-amber-300 dark:border-amber-800 bg-amber-500/10 text-amber-800 dark:text-amber-300">
  <div class="quote-id font-mono text-emerald-600 dark:text-emerald-400">Lombenax Quote ID: LX-QU-9912</div>
...
Lombenax دەتوانێت یارمەتیت بدات لە پەیوەندی کردن بە کارگەکانی دەرەوە (بەتایبەت لە چین و تورکیا) و کڕینی کاڵا بە باشترین نرخ و کوالیتی بەرز.
...
سوپاس بۆ پەیامەکەت. وەک یاریدەدەری هێڵی فریاگوزاری Lombenax، پرسیارەکەت گەیشت. من لێرەم بۆ یارمەتیدانت لە بواری بازرگانی و گواستنەوەی نێودەوڵەتی بۆ ناو عێراق.
...
تۆ هەروەها دەتوانیت لە ڕێگەی دوگمەی "سەرنج و تێبینی" فیدباک بنێریت یان پەیوەندی بە کارمەندانی پشتگیریمان بکەیت.`;
    ...
    if (msg.includes("مرحبا") || msg.includes("اهلين") || msg.includes("هلا") || msg.includes("من انت")) {
      return `⚠️ **(نظام الطوارئ غير المتصل - بسبب نفاد حصة واجهة Gemini API)**

مرحباً بك! أنا المساعد الذكي لشركة **Lombenax AI**. نظراً للضغط العالي ونفاد كوتا الاستخدام حالياً، أقوم بمساعدتك عبر محرك الاستجابة المحلي الذكي والآمن.
...
تساعدكم شركة Lombenax بالبحث عن أفضل المصانع في الصين وتركيا، التفاوض وتوفير البضائع ومراقبة الجودة بأقل التكاليف.
...
شكراً لرسالتك. بصفتي مساعد الطوارئ لشركة **Lombenax AI**، تم استقبال استفسارك بنجاح. أنا هنا لمساعدتك في مجال الشحن الدولي، التخليص الجمركي والتوريد للعراق.
